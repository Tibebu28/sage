...
// import { Text, View, Image, TextInput, Button } from "react-native";
import { Providers,useSelector } from 'react-redux';
  ...
  return (
    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }} >
      ...
      <Button title="click me" onPress={()=> alert("Button is clicked")} />
        <Button title="Increment" onPress={() => store.dispatch({ type: 'counter/increment' })} />
          <Button title="Decrement" onPress={() => store.dispatch({ type: 'counter/decrement' })} />
